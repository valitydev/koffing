...
export class PayoutsComponent implements OnInit {
    ...
    public payouts: Subject<Payment[]> = new Subject();
    ...
    public loadPayouts() {
        const searchParams = this.payoutsService.toSearchParams(this.limit, this.offset, this.searchForm.value);
        this.searchService.searchPayouts(this.shopID, searchParams).subscribe((response) => {
